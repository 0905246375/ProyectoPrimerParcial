...
public class ConsumerBanrural {

    private static final String QUEUE_NAME = "cola_banrural";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("BANRURAL escuchando...");
        ...
        DeliverCallback deliverCallback = (consumerTag, delivery) -> {
            ...
            System.out.println("Transacción recibida en BANRURAL:");
