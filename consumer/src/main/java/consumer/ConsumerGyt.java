...
public class ConsumerGyt {

    private static final String QUEUE_NAME = "cola_gyt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("GYT escuchando...");
        DeliverCallback deliverCallback = (consumerTag, delivery) -> {
            ...
            System.out.println("Transacción recibida en GYT:");
